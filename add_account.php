...
(6, 2.01, 'Dot Creation', 'text', 0, 'finding source', 'Media ⇒ Local Social Media ⇒ Facebook - Mission Ad', 'The finding source that you would like these referrals to be marked as. (This is written instruction for the person creating the dot)'),
(7, 2.02, 'Dot Creation', 'text', 0, 'most common language in mission', 'English', 'Most commonly spoken language in the mission'),
(8, 2.03, 'Dot Creation', 'textarea', 0, 'message', 'This is a new referral! Go contact them :)', 'Message that will teams can copy and paste while sending referrals'),
