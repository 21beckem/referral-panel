...
(6, 1.02, 'General', 'text', 0, 'pin code', '1022', 'The code that everyone will have to enter to open the Referral Suite app every time. Numbers only. Users can also use fingerprint instead'),
(7, 2.01, 'Dot Creation', 'text', 0, 'finding source', 'Media ⇒ Local Social Media ⇒ Facebook - Mission Ad', 'The finding source that you would like these referrals to be marked as. (This is written instruction for the person creating the dot)'),
(8, 2.02, 'Dot Creation', 'text', 0, 'most common language in mission', 'English', 'Most commonly spoken language in the mission'),
(9, 2.03, 'Dot Creation', 'textarea', 0, 'message', 'This is a new referral! Go contact them :)', 'Message that will teams can copy and paste while sending referrals'),
(10, 3.01, 'Home Page', 'json', 1, 'tutorials', '{\"Welcome to Referral Suite\":\"https:\\/\\/google.com\\/link_to_video\"}', 'Tutorials on how to use Referral Suite/be part of the team'),
(11, 4.02, 'Follow Ups', 'number', 0, 'initial delay after sent', '7', 'The number of days after a referral is sent before it appears again as a Follow-Up'),
(12, 4.01, 'Follow Ups', 'bool', 0, 'enable', '1', 'Enable the functionality of having referrals show up again after sent for the referral team to follow up with the teaching area missionaries on how the referral is doing'),
(13, 4.03, 'Follow Ups', 'json', 1, 'status delays', '{\"😭 Can\'t get in contact\":\"Grey\",\"😥 Not interested in contact\":\"Grey\",\"😫 Hasn\'t been contacted\":3,\"🤔 Hasn\'t responded\":5,\"😀 Currently in contact\":7,\"🤩 Appointment is set up!\":\"Green\"}', 'Right column is the text that will show up for the referral team to click on. Right column is the amount of days before the referral will show up again.\n\nIf the right column is not a number, that value will be saved to the referrals Area Book Status. Refer to help videos and defualt values. This will also turn off the follow-up process on this referral. AKA, this referral won\'t show up again for a follow-up');
HERA;
